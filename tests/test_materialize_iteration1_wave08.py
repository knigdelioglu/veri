...
class Iteration1Wave08MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-1-wave-08")
    ...
    def test_adversarial_records_are_prompt_injection_cases(self):
    ...
    def test_expected_id_ranges(self):
        ...
        expected={
            "tde09-written-000306","tde09-written-000325",
            "tde10-written-000311","tde10-written-000330",
            "tde11-speaking-000306","tde11-speaking-000325",
            "tde12-written-000306","tde12-written-000325",
            "tde12-listening-000286","tde12-listening-000305",
        }
