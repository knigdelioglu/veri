...
class Iteration2Wave06MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-2-wave-06")
    ...
    def test_distribution(self):
        ...
        self.assertEqual(Counter(r["grade"] for r in self.records), Counter({10: 40, 9: 20, 11: 20, 12: 20}))
    ...
    def test_review_uncertainty_is_grounded_and_material(self):
        for record in [r for r in self.records if r["gold_evaluation"]["needs_review"]]:
            ...
            text = record["student_response"]["text"].casefold()
            for uncertainty in uncertainties:
                self.assertIn(uncertainty["span"].casefold(), text)
    ...
    def test_expected_id_ranges(self):
        ...
        expected = {
            "tde09-written-000476", "tde09-written-000495",
            "tde10-written-000481", "tde10-written-000500",
            "tde10-speaking-000001", "tde10-speaking-000020",
            "tde11-written-000041", "tde11-written-000060",
            "tde12-listening-000456", "tde12-listening-000475",
        }
