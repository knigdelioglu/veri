...
class Iteration1Wave02MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_expected_id_ranges(self):
        ...
        expected={
            "tde09-written-000166","tde09-written-000185",
            "tde10-written-000171","tde10-written-000190",
            "tde11-speaking-000146","tde11-speaking-000165",
            "tde12-listening-000146","tde12-listening-000185",
        }
