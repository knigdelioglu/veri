...
class Iteration2Wave05MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-2-wave-05")
    ...
    def test_expected_id_ranges(self):
        ...
        expected = {
            "tde09-written-000456", "tde09-written-000475",
            "tde09-speaking-000021", "tde09-speaking-000040",
            "tde10-written-000461", "tde10-written-000480",
            "tde11-written-000021", "tde11-written-000040",
            "tde12-listening-000436", "tde12-listening-000455",
        }
