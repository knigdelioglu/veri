...
class Iteration1Wave04MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-1-wave-04")
    ...
    def test_expected_id_ranges(self):
        ...
        expected={
            "tde09-written-000206","tde09-written-000225",
            "tde10-written-000231","tde10-written-000250",
            "tde11-speaking-000186","tde11-speaking-000225",
            "tde12-listening-000206","tde12-listening-000225",
        }
