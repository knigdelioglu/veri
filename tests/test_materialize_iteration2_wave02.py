...
class Iteration2Wave02MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-2-wave-02")
    ...
    def test_expected_id_ranges(self):
        ...
        expected = {
            "tde09-written-000416", "tde09-written-000435",
            "tde10-written-000401", "tde10-written-000420",
            "tde10-listening-000021", "tde10-listening-000040",
            "tde11-speaking-000396", "tde11-speaking-000415",
            "tde12-listening-000376", "tde12-listening-000395",
        }
