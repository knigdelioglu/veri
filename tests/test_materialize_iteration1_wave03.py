...
class Iteration1Wave03MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-1-wave-03")
    ...
    def test_expected_id_ranges(self):
        ...
        expected={
            "tde09-written-000186","tde09-written-000205",
            "tde10-written-000191","tde10-written-000230",
            "tde11-speaking-000166","tde11-speaking-000185",
            "tde12-listening-000186","tde12-listening-000205",
        }
