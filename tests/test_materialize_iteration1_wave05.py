...
class Iteration1Wave05MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-1-wave-05")
    ...
    def test_expected_id_ranges(self):
        ...
        expected={
            "tde09-written-000226","tde09-written-000265",
            "tde10-written-000251","tde10-written-000270",
            "tde11-speaking-000226","tde11-speaking-000245",
            "tde12-listening-000226","tde12-listening-000245",
        }
