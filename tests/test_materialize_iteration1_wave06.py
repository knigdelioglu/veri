...
class Iteration1Wave06MaterializationTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.root = Path(__file__).resolve().parents[1]
        cls.records = build_batch_records(cls.root, batch="iteration-1-wave-06")
    ...
    def test_all_borderline_are_dual_reviewed_but_not_auto_escalated(self):
        ...
        self.assertTrue(any(not r["gold_evaluation"]["needs_review"] for r in borderline))
    ...
    def test_new_grade10_listening_series_is_isolated(self):
        ids={r["id"] for r in self.records}
        self.assertIn("tde10-listening-000001", ids)
        self.assertIn("tde10-listening-000020", ids)

    def test_expected_id_ranges(self):
        ids={r["id"] for r in self.records}
        expected={
            "tde09-written-000266","tde09-written-000285",
            "tde10-written-000271","tde10-written-000290",
            "tde10-listening-000001","tde10-listening-000020",
            "tde11-speaking-000246","tde11-speaking-000265",
            "tde12-listening-000246","tde12-listening-000265",
        }
